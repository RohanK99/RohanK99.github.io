          ...
          <div className="vertical-center">
            <div className="container text-center">
              <div className="text-group text-white">
                ...
                <h2>2A uwaterloo computer engineering</h2>
                <br/>
                <p>keen interest in artificial intelligence, web-dev and design</p>
                <p>In my spare time, you can find me playing the guitar or at the gym</p>
                <br/>
                <div className="social-buttons">
                  <a href={resume} target="_blank"><button id="resume">résumé</button></a>
                  <div className="divider" />
                  <a href={GITHUB_URL} target="_blank"><button id="github">Github</button></a>
                  <div className="divider" />
